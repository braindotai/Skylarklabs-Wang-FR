...
parser.add_argument('--db_path', default='/home/Dev-1/datasets/faces_emore/emore_images', help='source file name')
parser.add_argument('--label_file', default='/home/Dev-1/datasets/faces_emore/faces_emore.list', help='source file name')
