...
def train(args):
    ...
    best_cfp_fp_iters = 0
    total_iters = 0
    vis = Visualizer(env=args.model_pre + args.backbone, server='http://0.0.0.0', port=8000)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_root', type=str, default='/home/Dev-1/datasets/faces_emore/emore_images', help='train image root')
    parser.add_argument('--train_file_list', type=str, default='/home/Dev-1/datasets/faces_emore/faces_emore.list', help='train list')
    parser.add_argument('--lfw_test_root', type=str, default='/home/Dev-1/datasets/faces_emore/lfw', help='lfw image root')
    parser.add_argument('--lfw_file_list', type=str, default='/home/Dev-1/datasets/faces_emore/lfw_pair.txt', help='lfw pair file list')
    parser.add_argument('--agedb_test_root', type=str, default='/home/Dev-1/datasets/faces_emore/agedb_30', help='agedb image root')
    parser.add_argument('--agedb_file_list', type=str, default='/home/Dev-1/datasets/faces_emore/agedb_30_pair.txt', help='agedb pair file list')
    parser.add_argument('--cfpfp_test_root', type=str, default='/home/Dev-1/datasets/faces_emore/cfp_fp', help='agedb image root')
    parser.add_argument('--cfpfp_file_list', type=str, default='/home/Dev-1/datasets/faces_emore/cfp_fp_pair.txt', help='agedb pair file list')
