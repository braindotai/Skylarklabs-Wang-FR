...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str, default='/home/ubuntu/Work/datasets/faces_emore/lfw', help='The path of lfw data')
    parser.add_argument('--file_list', type=str, default='/home/ubuntu/Work/datasets/faces_emore/lfw_pair.txt', help='The path of lfw data')
    ...
    parser.add_argument('--resume', type=str, default='./checkpoints/feature.ckpt',
